...
arma::mat CNDO::updateDensityMatrixOptimized(std::map<int, BasisFunction> basis_map, AO AO_object, arma::mat overlap_mat, arma::mat Hcore_mat, arma::mat gamma_mat, vector<string> atom_types, vector<BasisFunction> basis_set, std::string output_file_name) {
